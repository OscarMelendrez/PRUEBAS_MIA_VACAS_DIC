...
type SuperBloque struct { //68 bytes
	...
	S_mtime             time.Time //ultima fecha en el que el sistema fue montado (time)
	S_umtime            time.Time //ultima fecha en el que el sistema fue desmontado (time)
...
type TablaInodo struct { //92 bytes
	...
	I_atime time.Time //ultima fecha en que se leyo el inodo sin modificarlo
	I_ctime time.Time //fecha en la que se creo el inodo
	I_mtime time.Time //ultima fecha en la que se modifica el inodo
